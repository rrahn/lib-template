...
#
#   LIB_TEMPLATE_FOUND            -- Indicate whether SeqAn was found and requirements met.
#
...
if (LIB_TEMPLATE_INCLUDE_DIR)
    lib_template_config_print ("lib_template include dir found:   ${LIB_TEMPLATE_INCLUDE_DIR}")
else ()
    lib_template_config_error ("lib_template include directory could not be found (LIB_TEMPLATE_INCLUDE_DIR: '${LIB_TEMPLATE_INCLUDE_DIR}')")
endif ()
...
add_library (seqan_lib_template INTERFACE)
target_compile_definitions (seqan_lib_template INTERFACE ${LIB_TEMPLATE_DEFINITIONS})
target_compile_options (seqan_lib_template INTERFACE ${LIB_TEMPLATE_CXX_FLAGS_LIST})
target_link_libraries (seqan_lib_template INTERFACE "${LIB_TEMPLATE_LIBRARIES}")
# include seqan3/include/ as -I, because seqan3 should never produce warnings.
target_include_directories (seqan_lib_template INTERFACE "${LIB_TEMPLATE_INCLUDE_DIR}")
# include everything except seqan3/include/ as -isystem, i.e.
# a system header which suppresses warnings of external libraries.
target_include_directories (seqan_lib_template SYSTEM INTERFACE "${LIB_TEMPLATE_DEPENDENCY_INCLUDE_DIRS}")
add_library (seqan::lib_template ALIAS seqan_lib_template)
